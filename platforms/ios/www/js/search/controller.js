...
.controller('SearchCtrl',
    [ '$templateCache','$rootScope','$scope', '$ionicLoading','$ionicModal','$stateParams','$ionicHistory','$state','Search','Cart','Ds','$ionicPopup',
        function($templateCache,$rootScope,$scope,$ionicLoading,$ionicModal,$stateParams,$ionicHistory,$state,Search,Cart,Ds,$routeParams,$ionicPopup){
