...
.controller('ProductCtrl',
    [ '$templateCache','$scope', '$ionicLoading','$ionicHistory','Product',
        function($templateCache,$scope,$ionicLoading,$ionicHistory,Product){
            ...
            //  $http.get(API.url('products/search?order_type=4'))
            //    .success(function(data) {
            //         //$scope.productList = $scope.productList.concat(data.content);
